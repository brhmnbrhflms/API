...
namespace EtoAPI.Controllers
{
    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        public static List<WeatherData> weatherDatas = new() 
        {
            ...
            new WeatherData() {Id = 30, Date = "30.05.2022", Degree = 3, Location = "Каллининград" },
        };
        ...
        public IActionResult GetById(int id)
        {
            ...
            return BadRequest("Запись не обнаружена");
        }
          ...
          for (int i = 0; i < weatherDatas.Count; i++)
            {
                ...
                {
                    return BadRequest("Запись с такми Id уже есть");
                }
            }
